<div>
    ...
    <ul>
        <li>be considered by the University to be a full-time student; and</li>
        <li>be of 18 years of age or older.</li>
    </ul>

    <p>
        By agreeing to this contract, you agree that you meet all of the above criteria. If, in the future,
    ...
    <p>
        You agree that any information, except direct messages, which you provide to us on the Website
        is public information and it may be:
    </p>

    <ul>
        <li>stored on our servers for perpetuity, unless your account is deleted; and</li>
        <li>shared with other users of the website for the purposes of matchmaking.</li>
    </ul>

    <p>
        By agreeing to this contract, you agree that any direct messages you send through the Website
        are not private and that we retain the right to share this information with third
        parties such as the University for the purposes of enforcing compliance with university policy.
    </p>

    <p>
        You agree that for all content (photos, text descriptions, etc.) you upload to our Website:
    </p>
    ...
    <p>
        ...
        discretion, discontinue providing the Website at any time, with or without notice.
    </p>
    <p>
        If you wish to terminate this Agreement, you may delete your account and cease using the Website.
        Once you delete your account, all of the data which you provided to us will be deleted.
    </p>
    <p>
    ...
    <p>
        This Terms of Service document is based on one developed by Automattic (http://wordpress.com/tos/) and is
